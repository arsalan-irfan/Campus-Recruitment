...
const studentNavbar = (props) => {
  const { firstname, lastname, initials } = props.currentUser
  return (
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav mr-auto">
          <li className="nav-item">
            <NavLink className="nav-link" activeStyle={{ color: 'white',fontWeight:"bold" }} to="/timeline/student">Home</NavLink>
          </li>
          <li className="nav-item">
            <NavLink className="nav-link" activeStyle={{ color: 'white',fontWeight:"bold" }} to="/student/profile">Profile</NavLink>
          </li>
          
          <li className="nav-item">            
            <NavLink className="nav-link" activeStyle={{ color: 'white',fontWeight:"bold" }} to="/student/applied">Applied Company</NavLink>
          </li>
        </ul>
